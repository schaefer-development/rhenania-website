	...
	<div class="mx-auto flex h-20 w-full max-w-screen-2xl flex-row items-center px-4 md:px-10">
		...
		<div class="flex flex-grow items-center justify-end">
			...
			<div class="flex grow justify-end pl-0 lg:grow-0 lg:pl-4">
				<a
					href="/de/kontakt"
					class="bg-rc_red hover:bg-rc_red-darker flex h-9 items-center justify-center px-2 text-sm font-medium tracking-wider text-white uppercase hover:text-white"
