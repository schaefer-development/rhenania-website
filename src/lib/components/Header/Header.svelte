<script lang="ts">
	...
	import LanguageToggle from '$lib/components/LanguageToggle/LanguageToggle.svelte';
...
=======
		<div id="searchbar" class="grow flex justify-end items-center px-2 md:px-6 lg:px-12">
			<form
				class="input-group relative flex items-stretch w-full justify-end pl-4"
				on:submit|preventDefault={search($page)}
			>
...
>>>>>>> b6a5c6d (feat: language toggler placed in header)
		...
		<div
			id="navbar"
			class="grow lg:grow-0 justify-end items-center hidden lg:flex invisible lg:visible"
		>
			<!-- menu points -->
